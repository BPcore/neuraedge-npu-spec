...
cd "/home/bandhan/Documents/BP core/VS CODE/phase4_week3/simulation_reports/work_sim_gate_20250814_023258"
...
iverilog -g2012 \
    ...
    2>&1 | tee "/home/bandhan/Documents/BP core/VS CODE/phase4_week3/logs/iverilog_compile_sim_gate_20250814_023258.log"

if [[ ${PIPESTATUS[0]} -ne 0 ]]; then
    echo "✗ Compilation failed - check /home/bandhan/Documents/BP core/VS CODE/phase4_week3/logs/iverilog_compile_sim_gate_20250814_023258.log"
    exit 1
fi
...
vvp gate_sim \
    ...
    2>&1 | tee "/home/bandhan/Documents/BP core/VS CODE/phase4_week3/logs/iverilog_sim_gate_20250814_023258.log"
